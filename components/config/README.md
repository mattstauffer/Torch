...
The config component tries to demonstrate how we can use the [Laravel Config](https://laravel.com/docs/5.4/configuration/) package to store our configs in a array and display the same.

## Usage
Run the following to serve a web site from that directory:
...
To add more configs to for testing purposes we can add them on the **config/app.php** file or you can add more files and import them in the index.php.
