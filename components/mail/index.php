 ...
 *
 * @author This example based on original PR from https://github.com/tunr
...
$app->get('/', function ()
{
    ...
    // chose a transport (SMTP, PHP Mail, Sendmail, Mailgun, Mandrill, Log)
    ...
    $mailer->send('email.welcome', $data, function($message) {
        ...
        $message->to(getenv('MAIL_TO_ADDRESS'), 'Barack Obama');
        $message->subject('Yo!');
    });
